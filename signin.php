      ...
      <form method="POST" id="contact_form" action="login.php">
        <div class="mail">
         ...
         <p> Please enter your email address</p>
          <input id=mail name=mail type=text placeholder="e.g. example@domain.com"  onChange="cemail(mail)" />
        ...
        <div id="loader">
          ...
          <input id="register" type="button" value="Register now" name="submit"/>
...
function paswrd(pass)
{
	...
	if(pass.value.match(letters))
	{
		if(len<3 || len>15)
		{
			document.getElementById('pss').innerHTML = 'Password must be within '+ 3+ 'to'+ 15+' characters.';
			document.getElementById(nme).value='';
			document.getElementById(nme).focus();
		}
		else
