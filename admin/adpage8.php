...
$addetails = "select * from ad_details a,real_estate r where r.ad_no='$adno' and a.ad_no='$adno' ";
...
<h2>$adrow[ad_title]</h2>
  ...
  <div class='two_third lastcolumn'>
    <h3>AD DETAILS</h3>
    <p>BEDROOMS: $adrow[bedrooms]</p>
    <p>BATHROOMS: $adrow[bathrooms]</p>
    <p>AREA: $adrow[area]</p>
    <p>CONDITION: $adrow[condition]</p>
    <p>CARPARKING: $adrow[carparking]</p>
    <p>RENT PAID: $adrow[rent_paid]</p>
    <p>RENT RUPEES: $adrow[rent_rupees]</p>
    <p>
...
<p class='portfolio'><a href='#'>Project Details</a> | <a href='#'>Visit Website</a></p>
 ...
 $caddetails = "SELECT * FROM ad_details WHERE s_id IN (SELECT s_id FROM ad_details WHERE ad_no ='$adno') AND ad_no <> '$adno'";
...
<div class='commentBody'>
              ...
              <p>$cdesc...</p>
  <a href='adpage8.php?ad_no=$cadrow[ad_no]' class='buttonhome fl'> more<span>+</span></a>
</div>
";
	  }
  }
