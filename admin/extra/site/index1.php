      ...
      <div class="mainmenu">
        <div id="mainmenu">
          <ul class="sf-menu">
            ...
            <li><a href="blog.html" id="visited"><span class="home"><img src="images/blog.png" alt="" /></span>Blog</a>
              <ul>
  ...
  <div class="container boxthree">
    <div class="one_third">
      <section class="boxthreeleft">
        <img src="images/home/1.png" alt="" width="200" height="120" align="absmiddle"/>
        <h3>health beauty and fitness</h3>
<p>Lorem Ipsum is simply dummy text of the printing and tesetting industry.</p>
      <a class ="simple" href="#">+ Learn more</a></section>
    </div>
    <!-- one-third column ends here -->
    <div class="one_third">
      <section class="boxthreecenter"> <img src="images/home/2.png" alt="" width="200" height="120"/>
        <h3>services</h3>
    ...
    <div class="one_third lastcolumn">
      <section class="boxthreeright"> <img src="images/home/3.png" alt="" width="200" height="120"/>
  ...
  <div class="container boxthree">
    <div class="one_third">
      <section class="boxthreeleft"> <img src="images/home/1.png" alt="" width="200" height="120"/>
...
<!-- TemplateEndEditable --><!-- container ends here -->
